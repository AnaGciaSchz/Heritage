...
export default function SearchResult(props) {
    return (
        ...
        <div className={styles.searchFeed}>
            ...
            />
            <SearchCard
                name="Ana María García Sánchez Hola"
                img="/Ana.jpg"
                alt="Imagen"
                firtsLine="Promoción 2020-2021"
                text="Lalalalala Lalalallalalal Lalalalalall lalalallala lslslsllslslsllslslEstudiante de cuarto curso, está intentando recordar cómo se programaba con React."
                date="20/09/2021"
                descriptionTitle="Descripción"
                description="Lalalalala Lalalallalalal Lalalalalall lalalallflkgjdflkgjfdkljgdflgjlkfdkkjkala lslslsllslslsllslslEstudiante de cuarto curso, está intentando recordar cómo se programaba con React.jsjroernrkjsdfkjdsh kjdshfkjdshgkjdhgkjdfhgkjhgsd"
                beenTitle="Ha estado en"
                been="Lalalalala Lalalallalalal Lalalalalall lalalallflkgjdflkgjfdkljgdflgjlkfdkkjkala lslslsllslslsllslslEstudiante de cuarto curso, está intentando recordar cómo se programaba con React.jsjroernrkjsdfkjdshkjdshfkjd shgkjdhgkjdfhgkjhgsd"
                red1="Whatsapp"
                red1Link="https://es.reactjs.org/docs/conditional-rendering.html"
                red2="Twitter"
                red2Link="https://www.w3schools.com/css/css_link.asp"

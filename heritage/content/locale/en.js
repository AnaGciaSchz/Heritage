export const en = {
  ...
  "/about": {
    ...
    PorqueHeritageRespuesta: "This website wants to reflect the heritage of our school. There are many ways to reflect this idea, but apart from being a word that somewhat affectionately reflects the main idea of ​​this work, it also allows us to make a play on words and insert the sail of our school ('EII') into the word itself. logo. This is the original name that the tutor of this TFG, Jose Manuel Redondo, gave to the project, and it was so appropriate that it was left as the definitive one.",

    ...
    return (
        ...
        <div className={styles.searchFeed}>
            ...
            <SearchCard
                ...
                text="lalalala Lalalallalalal Lalalalalall lalalallala lslslsllslslsllslslEstudiante de cuarto curso, está intentando recordar cómo se programaba con React."
                date="20/09/2021"
                descriptionTitle="Descripción"
                description="lalalala Lalalallalalal Lalalalalall lalalallflkgjdflkgjfdkljgdflgjlkfdkkjkala lslslsllslslsllslslEstudiante de cuarto curso, está intentando recordar cómo se programaba con React.jsjroernrkjsdfkjdsh kjdshfkjdshgkjdhgkjdfhgkjhgsd"

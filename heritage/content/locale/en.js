export const en = {
  "/": {
    ...
    ZExalumnado: "Graduates",
    ZProfesorado: "Teachers",
    ZDelegacion: "Former Delegates",
    ...
    AnaDescripcion: "Student of the EII and author of this TFG",
  ...
  "/EditorHistoria": {
    ...
    NoEliminado: "The card couldn't be deleted. Try again",
    TituloButton: "Menu icon",
    EditorHistoriaTitulo: "EII's History Editor",
    MapaSitioWeb: "Site map",
  ...
  "/about": {
    ...
    QueEsHeritageSegundoParrafo: "The objective of this page is to spread the history of the EII, which consists of very interesting moments for computer science in Asturias, and to show how far some of the graduates have come in their professional careers. Space has also been left for a couple of sections specials, one to talk about our Teachers(past and present) and one for our student representatives.",
    AnaDescripcion: "Student of the EII and author of this TFG",
    AnaDescripcionLarga: "Ana is a student of the Computer Software Engineering Degree who hopes to deliver this Final Degree Project in 2022 and thus obtain her degree.",
    AnaLogros: "Among her achievements we can find daring to design Heritage from scratch, trying to make the page responsive or writing this special card with information from her.",
    PorqueHeritage: "Why Heritage?",
    PorqueHeritageRespuesta: "This website wants to reflect the heritage of our school. There are many ways to reflect this idea, but apart from being a word that somewhat affectionately reflects the main idea of ​​this work, it also allows us to make a play on words and insert the sigras of our school ('EII') into the word itself. logo. This is the original name that the tutor of this TFG, Jose Manuel Redondo, gave to the project, and it was so appropriate that it was left as the definitive one.",
    PorqueUnOso: "Why a bear?",
    PorqueUnOsoRespuesta: "The bear that is part of the Heritage logo is Petra. It is the official mascot of the EII since 2021 and is used from time to time by the EII Student Delegation in documents and publications on networks. The reason that it has also been chosen as a Heritage logo is that, apart from being a good resource to represent the School, both the tutor of this TFG and the author were included in the creation of the mascot, so the opportunity was taken to include it in more resources of the EII.",
  ...
  "/SubidaDeCartas": {
    ...
    EscribeLogros: "You have to write the achievements",
    ...
    LogrosEjemplo: "Achievements as alumni, teacher or delegate depending on the type of card",
    LogrosTooltip: "Achievements of the person. Max characters: 230",
